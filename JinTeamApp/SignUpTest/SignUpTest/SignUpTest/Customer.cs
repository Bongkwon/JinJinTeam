...
namespace SignUpTest
{
    class Customer
    {
        ...
        public Customer(string cus_ID, string cus_pwd, string cus_phone, string cus_addr, string cus_name, string cus_Nickname, bool cus_gender, int cus_age) : this()
        {
        ...
        public Customer(int cus_no, string cus_ID, string cus_pwd, string cus_phone, string cus_addr, string cus_name, string cus_Nickname, bool cus_gender, int cus_age) : this()
        {
            this.cus_no = cus_no;
            this.cus_ID = cus_ID ?? throw new ArgumentNullException(nameof(cus_ID));
            this.cus_pwd = cus_pwd ?? throw new ArgumentNullException(nameof(cus_pwd));
