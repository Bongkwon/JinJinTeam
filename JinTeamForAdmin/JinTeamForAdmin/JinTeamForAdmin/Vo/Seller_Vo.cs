...
namespace JinTeamForAdmin.Vo
{
    public class Seller_Vo
    {
        ...
        public Seller_Vo(string seller_Id, string seller_pwd, string seller_name, string seller_addr, string seller_boss, string seller_phone, string seller_postal, string seller_email, string seller_fax, string return_addr, string corporate_registration_no)
        {
        ...
        {
            var seller = obj as Seller_Vo;
            return seller != null &&
                seller_No == seller.Seller_NO &&
                seller_state == seller.Seller_state &&
                join_state == seller.join_state;
        }
    }
}
